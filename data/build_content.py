...
_PRIVACY_META = {
 "en":"Privacy notice for ReStory Guides: GA4 analytics, Adsterra advertising from effectivecpmnetwork.com, cookies, device/network data and browser controls.",
 "zh-CN":"ReStory 攻略站隐私说明：GA4 分析、effectivecpmnetwork.com 的 Adsterra 广告、Cookie、设备/网络数据与浏览器控制。",
 "zh-TW":"ReStory 攻略站隱私說明：GA4 分析、effectivecpmnetwork.com 的 Adsterra 廣告、Cookie、裝置/網路資料與瀏覽器控制。",
 "ja":"ReStory 攻略ガイドのプライバシー情報：GA4、effectivecpmnetwork.com の Adsterra 広告、Cookie、端末・ネットワークデータとブラウザ設定。",
 "ko":"ReStory 가이드 개인정보 안내: GA4 분석, effectivecpmnetwork.com의 Adsterra 광고, 쿠키, 기기·네트워크 데이터와 브라우저 설정.",
 "fr":"Confidentialité de ReStory Guides : GA4, publicité Adsterra via effectivecpmnetwork.com, cookies, données réseau/appareil et contrôles du navigateur.",
 "de":"Datenschutz bei ReStory Guides: GA4, Adsterra-Werbung über effectivecpmnetwork.com, Cookies, Netzwerk-/Gerätedaten und Browser-Einstellungen.",
 "es":"Privacidad de ReStory Guides: GA4, publicidad de Adsterra mediante effectivecpmnetwork.com, cookies, datos de red/dispositivo y controles del navegador.",
 "pt-BR":"Privacidade do ReStory Guides: GA4, anúncios da Adsterra via effectivecpmnetwork.com, cookies, dados de rede/aparelho e controles do navegador.",
 "ru":"Конфиденциальность ReStory Guides: GA4, реклама Adsterra через effectivecpmnetwork.com, cookie, сетевые данные/устройство и настройки браузера.",
}
for _lg in LANGS:
...
# ---- P0 factual boundaries: Zen and per-device pages ----
# The official Steam achievement snapshot proves only that A Place Of Zen
# requires more than 100 Zen points. It does not prove item prices, an optimal
# purchase route, or repeat-purchase behavior, so the page deliberately asks
# players to enter the total shown by their current game.
_ZEN_SAFE = {
 "en": ["Zen Points: A Place Of Zen", "ReStory Zen Points: Official Achievement Threshold", "A Place Of Zen requires more than 100 Zen points. Check the official condition and compare it with the total shown in your game.", "The official Steam condition for A Place Of Zen is to accumulate more than 100 Zen points. Item prices, repeat-purchase behavior and a guaranteed cheapest route are not verified here.", "Official requirement", "Accumulate more than 100 Zen points", "How to verify your progress", "Read the Zen total shown in your current game and enter that number in the calculator below. A total of exactly 100 does not meet the official wording; the total must be above 100.", "What unlocks A Place Of Zen?", "More than 100 Zen points, according to Steam's official achievement condition.", "Is there a verified cheapest route?", "No. Item prices, repeat-purchase behavior and an optimal route are not established by the official achievement data."],
 "zh-CN": ["Zen 点数：A Place Of Zen", "ReStory Zen 点数：官方成就门槛", "A Place Of Zen 要求 Zen 点数超过 100。请核对官方条件，并与游戏当前显示的合计比较。", "Steam 官方条件是累计超过 100 Zen 点数。本站未核实物品价格、重复购买行为或保证最便宜的路线。", "官方要求", "累计超过 100 Zen 点数", "如何核对进度", "读取当前游戏显示的 Zen 合计，并在下方计算器输入。正好 100 不符合官方措辞；合计必须大于 100。", "A Place Of Zen 如何解锁？", "根据 Steam 官方成就条件，需要超过 100 Zen 点数。", "有已验证的最便宜路线吗？", "没有。官方成就数据不能证明物品价格、重复购买行为或最优路线。"],
 "zh-TW": ["Zen 點數：A Place Of Zen", "ReStory Zen 點數：官方成就門檻", "A Place Of Zen 要求 Zen 點數超過 100。請核對官方條件，並與遊戲目前顯示的合計比較。", "Steam 官方條件是累積超過 100 Zen 點數。本站未核實物品價格、重複購買行為或保證最便宜的路線。", "官方要求", "累積超過 100 Zen 點數", "如何核對進度", "讀取目前遊戲顯示的 Zen 合計，並在下方計算器輸入。正好 100 不符合官方措辭；合計必須大於 100。", "A Place Of Zen 如何解鎖？", "根據 Steam 官方成就條件，需要超過 100 Zen 點數。", "有已驗證的最便宜路線嗎？", "沒有。官方成就資料不能證明物品價格、重複購買行為或最佳路線。"],
 "ja": ["Zenポイント：A Place Of Zen", "ReStory Zenポイント：公式実績条件", "A Place Of Zen の条件は Zen ポイントを100より多く貯めることです。公式条件とゲーム内の現在値を照合してください。", "Steam公式条件は Zen ポイントを100より多く貯めることです。アイテム価格、重複購入の挙動、最安ルートは本ページでは検証できていません。", "公式条件", "Zen ポイントを100より多く貯める", "進捗の確認方法", "現在のゲームに表示される Zen 合計を読み、下の計算機に入力してください。ちょうど100は公式文言を満たさず、100を超える必要があります。", "A Place Of Zen の解除条件は？", "Steam公式実績条件によると、Zen ポイントを100より多く貯めることです。", "検証済みの最安ルートはある？", "ありません。公式実績データからは、価格、重複購入、最適ルートを確認できません。"],
 "ko": ["Zen 포인트: A Place Of Zen", "ReStory Zen 포인트: 공식 업적 기준", "A Place Of Zen은 Zen 포인트를 100보다 많이 모아야 합니다. 공식 조건과 게임에 표시된 현재 합계를 비교하세요.", "Steam 공식 조건은 Zen 포인트를 100보다 많이 누적하는 것입니다. 아이템 가격, 중복 구매 동작, 보장된 최저가 경로는 확인되지 않았습니다.", "공식 조건", "Zen 포인트를 100보다 많이 누적", "진행 상황 확인", "현재 게임에 표시된 Zen 합계를 확인해 아래 계산기에 입력하세요. 정확히 100은 공식 문구를 충족하지 않으며 100을 넘어야 합니다.", "A Place Of Zen은 어떻게 해제하나요?", "Steam 공식 업적 조건에 따르면 Zen 포인트가 100보다 많아야 합니다.", "검증된 최저가 경로가 있나요?", "없습니다. 공식 업적 데이터로는 가격, 중복 구매 또는 최적 경로를 확인할 수 없습니다."],
 "fr": ["Points Zen : A Place Of Zen", "Points Zen ReStory : seuil officiel du succès", "A Place Of Zen exige plus de 100 points Zen. Comparez la condition officielle au total affiché dans votre partie.", "La condition officielle Steam demande d'accumuler plus de 100 points Zen. Les prix, les achats répétés et un parcours le moins cher garanti ne sont pas vérifiés ici.", "Condition officielle", "Accumuler plus de 100 points Zen", "Vérifier votre progression", "Relevez le total Zen affiché dans votre partie et saisissez-le dans le calculateur. Exactement 100 ne satisfait pas le texte officiel : il faut dépasser 100.", "Comment débloquer A Place Of Zen ?", "Avec plus de 100 points Zen, selon la condition officielle Steam.", "Existe-t-il un parcours le moins cher vérifié ?", "Non. Les données officielles du succès n'établissent ni prix, ni achats répétés, ni parcours optimal."],
 "de": ["Zen-Punkte: A Place Of Zen", "ReStory Zen-Punkte: offizielle Bedingung", "A Place Of Zen verlangt mehr als 100 Zen-Punkte. Vergleichen Sie die offizielle Bedingung mit der im Spiel angezeigten Summe.", "Die offizielle Steam-Bedingung lautet: mehr als 100 Zen-Punkte sammeln. Preise, Mehrfachkäufe und eine garantiert günstigste Route sind hier nicht verifiziert.", "Offizielle Bedingung", "Mehr als 100 Zen-Punkte sammeln", "Fortschritt prüfen", "Lesen Sie die aktuelle Zen-Summe im Spiel ab und tragen Sie sie unten ein. Genau 100 erfüllt den offiziellen Wortlaut nicht; die Summe muss über 100 liegen.", "Wie wird A Place Of Zen freigeschaltet?", "Mit mehr als 100 Zen-Punkten, laut offizieller Steam-Bedingung.", "Gibt es eine verifizierte günstigste Route?", "Nein. Die offiziellen Erfolgsdaten belegen weder Preise noch Mehrfachkäufe oder eine optimale Route."],
 "es": ["Puntos Zen: A Place Of Zen", "Puntos Zen de ReStory: requisito oficial", "A Place Of Zen exige más de 100 puntos Zen. Compara la condición oficial con el total que muestra tu partida.", "La condición oficial de Steam pide acumular más de 100 puntos Zen. Aquí no están verificados los precios, las compras repetidas ni una ruta más barata garantizada.", "Requisito oficial", "Acumula más de 100 puntos Zen", "Cómo comprobar el progreso", "Mira el total Zen de tu partida e introdúcelo en la calculadora. Exactamente 100 no cumple el texto oficial: debe ser superior a 100.", "¿Cómo se desbloquea A Place Of Zen?", "Con más de 100 puntos Zen, según la condición oficial de Steam.", "¿Hay una ruta más barata verificada?", "No. Los datos oficiales del logro no establecen precios, compras repetidas ni una ruta óptima."],
 "pt-BR": ["Pontos Zen: A Place Of Zen", "Pontos Zen de ReStory: requisito oficial", "A Place Of Zen exige mais de 100 pontos Zen. Compare a condição oficial com o total mostrado no seu jogo.", "A condição oficial da Steam é acumular mais de 100 pontos Zen. Preços, compras repetidas e uma rota mais barata garantida não foram verificados aqui.", "Requisito oficial", "Acumule mais de 100 pontos Zen", "Como conferir o progresso", "Veja o total Zen mostrado no jogo e digite-o na calculadora. Exatamente 100 não atende ao texto oficial; o total precisa passar de 100.", "Como desbloquear A Place Of Zen?", "Com mais de 100 pontos Zen, segundo a condição oficial da Steam.", "Existe uma rota mais barata verificada?", "Não. Os dados oficiais da conquista não comprovam preços, compras repetidas nem uma rota ideal."],
 "ru": ["Очки дзен: A Place Of Zen", "Очки дзен ReStory: официальное условие", "Для A Place Of Zen нужно накопить больше 100 очков дзен. Сравните официальное условие с текущей суммой в игре.", "Официальное условие Steam — накопить больше 100 очков дзен. Цены предметов, повторные покупки и гарантированно самый дешёвый маршрут здесь не подтверждены.", "Официальное условие", "Накопить больше 100 очков дзен", "Как проверить прогресс", "Посмотрите текущую сумму дзен в игре и введите её в калькулятор. Ровно 100 не соответствует официальной формулировке: нужно больше 100.", "Как открыть A Place Of Zen?", "Накопить больше 100 очков дзен, согласно официальному условию Steam.", "Есть подтверждённый самый дешёвый маршрут?", "Нет. Официальные данные достижения не подтверждают цены, повторные покупки или оптимальный маршрут."],
}
_ZEN_UI = {
...
_ZEN_INTRO = {
 "en":"The official Steam condition for A Place Of Zen is to accumulate more than 100 Zen points. This page does not infer any additional acquisition mechanics from that condition; compare it with the total shown in your current game.",
 "zh-CN":"Steam 官方条件是累计超过 100 Zen 点数。本页不会从该条件推断其他获取机制；请与当前游戏显示的合计比较。",
 "zh-TW":"Steam 官方條件是累積超過 100 Zen 點數。本頁不會從該條件推斷其他取得機制；請與目前遊戲顯示的合計比較。",
 "ja":"Steam公式条件は Zen ポイントを100より多く貯めることです。この条件から他の入手仕様を推測せず、現在のゲームに表示される合計と照合してください。",
 "ko":"Steam 공식 조건은 Zen 포인트를 100보다 많이 누적하는 것입니다. 이 조건에서 다른 획득 방식을 추정하지 않으며, 현재 게임에 표시된 합계와 비교하세요.",
 "fr":"La condition officielle Steam demande d'accumuler plus de 100 points Zen. Cette page n'en déduit aucun autre mécanisme d'obtention ; comparez-la au total affiché dans votre partie.",
 "de":"Die offizielle Steam-Bedingung lautet: mehr als 100 Zen-Punkte sammeln. Diese Seite leitet daraus keine weiteren Erwerbsmechaniken ab; vergleichen Sie sie mit der aktuellen Summe im Spiel.",
 "es":"La condición oficial de Steam pide acumular más de 100 puntos Zen. Esta página no deduce otras mecánicas de obtención; compárala con el total de tu partida.",
 "pt-BR":"A condição oficial da Steam é acumular mais de 100 pontos Zen. Esta página não deduz outras mecânicas de obtenção; compare com o total mostrado no jogo.",
 "ru":"Официальное условие Steam — накопить больше 100 очков дзен. Страница не выводит из него другие механики получения; сравните условие с текущей суммой в игре.",
}
for page in PAGES:
    if page["slug"] != "zen-points": continue
    page["sources"] = [SRC_STEAM_ACHIEVEMENTS, SRC_STEAM]
    for lg in LANGS:
        z = _ZEN_SAFE[lg]
        t = page["i18n"][lg]
        t.update({"title": z[0], "metaTitle": z[1], "metaDescription": z[2], "intro": _ZEN_INTRO[lg], "sections": [
            {"type":"table", "heading":z[4], "columns":[z[4], z[5]], "rows":[["A Place Of Zen", z[5]]]},
            {"type":"note", "heading":z[6], "body":z[7]},
            {"type":"faq", "heading":"FAQ", "items":[[z[8],z[9]]]},
        ]})
        ui = _ZEN_UI[lg]
        SITE_I18N[lg].update({"zenCalcTitle":ui[0], "zenCalcLead":ui[1], "zenTotal":ui[2], "zenTarget":ui[3], "zenReset":ui[4]})

_DEVICE_UI = {
 "en": ["Device Profile", "ReStory Device Profile", "This page identifies a repairable ReStory device. Its exact in-game procedure is still being verified.", "Verification status", "Listed as a repairable device", "Procedure", "Not yet verified", "What is verified", "The device identity is retained for lookup. Exact parts, failure states, tools, order, difficulty, progression and reward value have not been verified.", "Can I use this as a step-by-step repair guide?", "No. A device-specific procedure will be added only after it is verified against traceable game evidence."],
 "zh-CN": ["设备资料", "ReStory 设备资料", "本页用于识别 ReStory 中可维修的设备；准确的游戏内流程仍待核实。", "核实状态", "已列为可维修设备", "具体流程", "尚未核实", "已核实范围", "保留设备名称供查询。具体零件、故障状态、工具、顺序、难度、进度位置和奖励价值尚未核实。", "能把本页当作分步维修攻略吗？", "不能。只有在可追溯的游戏证据核实后，才会补充设备专属流程。"],
 "zh-TW": ["裝置資料", "ReStory 裝置資料", "本頁用於識別 ReStory 中可維修的裝置；準確的遊戲內流程仍待核實。", "核實狀態", "已列為可維修裝置", "具體流程", "尚未核實", "已核實範圍", "保留裝置名稱供查詢。具體零件、故障狀態、工具、順序、難度、進度位置和獎勵價值尚未核實。", "能把本頁當作分步維修攻略嗎？", "不能。只有在可追溯的遊戲證據核實後，才會補充裝置專屬流程。"],
 "ja": ["デバイス情報", "ReStory デバイス情報", "ReStoryで修理可能なデバイスを確認するページです。ゲーム内の正確な手順は検証中です。", "検証状況", "修理可能デバイスとして掲載", "固有手順", "未検証", "確認済みの範囲", "検索用にデバイス名を保持しています。部品、故障状態、ツール、順序、難易度、進行位置、報酬価値は未検証です。", "手順ガイドとして使える？", "いいえ。追跡可能なゲーム証拠で確認できた後にのみ、固有手順を追加します。"],
 "ko": ["기기 정보", "ReStory 기기 정보", "ReStory에서 수리 가능한 기기를 식별하는 페이지입니다. 정확한 게임 내 절차는 아직 확인 중입니다.", "확인 상태", "수리 가능 기기로 등재", "전용 절차", "미확인", "확인된 범위", "검색을 위해 기기 이름을 유지합니다. 부품, 고장 상태, 도구, 순서, 난이도, 진행 위치와 보상 가치는 확인되지 않았습니다.", "단계별 수리 가이드로 사용할 수 있나요?", "아니요. 추적 가능한 게임 증거로 확인된 뒤에만 기기별 절차를 추가합니다."],
 "fr": ["Fiche appareil", "Fiche appareil ReStory", "Cette page identifie un appareil réparable de ReStory. Sa procédure exacte en jeu reste à vérifier.", "État de vérification", "Répertorié comme appareil réparable", "Procédure", "Pas encore vérifiée", "Ce qui est vérifié", "Le nom de l'appareil est conservé pour la recherche. Pièces, pannes, outils, ordre, difficulté, progression et valeur de récompense ne sont pas vérifiés.", "Puis-je suivre cette page pas à pas ?", "Non. Une procédure propre à l'appareil ne sera ajoutée qu'après vérification par des preuves de jeu traçables."],
 "de": ["Geräteprofil", "ReStory Geräteprofil", "Diese Seite identifiziert ein reparierbares Gerät in ReStory. Der genaue Ablauf im Spiel ist noch nicht verifiziert.", "Prüfstatus", "Als reparierbares Gerät gelistet", "Ablauf", "Noch nicht verifiziert", "Verifizierter Umfang", "Der Gerätename bleibt zur Suche erhalten. Teile, Fehlerzustände, Werkzeuge, Reihenfolge, Schwierigkeit, Fortschritt und Belohnungswert sind nicht verifiziert.", "Ist dies eine Schritt-für-Schritt-Anleitung?", "Nein. Ein gerätespezifischer Ablauf wird erst nach Prüfung anhand nachvollziehbarer Spielbelege ergänzt."],
 "es": ["Ficha del dispositivo", "Ficha de dispositivo de ReStory", "Esta página identifica un dispositivo reparable de ReStory. Su procedimiento exacto en el juego sigue pendiente de verificación.", "Estado de verificación", "Figura como dispositivo reparable", "Procedimiento", "Aún no verificado", "Alcance verificado", "Se conserva el nombre para búsquedas. No se han verificado piezas, fallos, herramientas, orden, dificultad, progreso ni valor de recompensa.", "¿Es una guía paso a paso?", "No. Solo se añadirá un procedimiento propio del dispositivo tras verificarlo con pruebas trazables del juego."],
 "pt-BR": ["Perfil do aparelho", "Perfil de aparelho de ReStory", "Esta página identifica um aparelho reparável de ReStory. O procedimento exato no jogo ainda está em verificação.", "Status da verificação", "Listado como aparelho reparável", "Procedimento", "Ainda não verificado", "Escopo verificado", "O nome do aparelho é mantido para pesquisa. Peças, falhas, ferramentas, ordem, dificuldade, progresso e valor de recompensa não foram verificados.", "Posso usar como guia passo a passo?", "Não. Um procedimento específico só será adicionado após verificação com evidência rastreável do jogo."],
 "ru": ["Профиль устройства", "Профиль устройства ReStory", "Страница идентифицирует ремонтируемое устройство ReStory. Точная игровая процедура ещё проверяется.", "Статус проверки", "Указано как ремонтируемое устройство", "Процедура", "Пока не подтверждена", "Что подтверждено", "Название устройства сохранено для поиска. Детали, неисправности, инструменты, порядок, сложность, этап прогресса и ценность награды не подтверждены.", "Это пошаговый гайд по ремонту?", "Нет. Процедура появится только после проверки по отслеживаемым игровым доказательствам."],
}
for page in PAGES:
    if not page["slug"].startswith("devices/"): continue
    for lg in LANGS:
        t, u = page["i18n"][lg], _DEVICE_UI[lg]
        device_name = t.get("title", page["title"])
        for suffix in (" Repair Guide", "维修攻略", "維修攻略", "修理ガイド", " 수리 가이드", " Guide de réparation", " Reparatur-Guide", " Guía de reparación", " Guia de Conserto", " — гайд по ремонту"):
            device_name = device_name.replace(suffix, "")
        t.update({"title":f"{device_name} — {u[0]}", "metaTitle":f"{device_name} — {u[1]}", "metaDescription":f"{device_name}: {u[2]}", "intro":u[2], "sections":[
            {"type":"table", "heading":u[0], "columns":[u[3],u[4]], "rows":[[u[3],u[4]],[u[5],u[6]]]},
            {"type":"note", "heading":u[7], "body":u[8]},
            {"type":"faq", "heading":"FAQ", "items":[[u[9],u[10]]]},
        ]})

# The default-language renderer reads i18n.en, but keep the page-level fields
# synchronized as well so no stale speculative copy remains in site.json.
for page in PAGES:
    en = page["i18n"]["en"]
